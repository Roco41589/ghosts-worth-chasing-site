...
const DOCUMENTS: GWCDocument[] = [
  ...
  },
  {
    ...
    type: ["Annual Filing"],
    description: "First annual information return. Required of public charities with gross receipts under $200,000 and total assets under $500,000. Tax-exempt status effective February 2026 — this is the first year in which the organization operated as a recognized 501(c)(3).",
    year: "2026",
    filedDate: null,
    postedDate: null,
    status: "Not Yet Due",
    statusNote: "Due May 15, 2027 (standard) or November 15, 2027 (extended). Will be posted within 30 days of filing.",
    mandatory: true,
    fileUrl: null,
    fileSize: null,
  },
  ...
  {
    id: "DOC-006", title: "Whistleblower Policy", type: ["Governance"],
  ...
  {
    id: "DOC-007", title: "Document Retention Policy", type: ["Governance"],
  ...
  {
    id: "DOC-010", title: "Whistleblower Policy", type: ["Governance"],
  ...
  {
    id: "DOC-011", title: "Grantmaking Policy", type: ["Governance"],
  ...
  {
    id: "DOC-012", title: "Investment Policy Statement", type: ["Governance"],
  ...
  {
    id: "DOC-013", title: "Financial Controls & Procedures Policy", type: ["Governance"],
...
const THIRD_PARTY_SOURCES: ThirdPartySource[] = [
  ...
  { name: "Candid / GuideStar",                 url: "https://app.candid.org/profile/16517045/ghosts-worth-chasing-39-4369238",                         desc: "Sector's primary funder research database. Includes 990s and self-reported data.", delay: "Variable — we update our profile directly" },
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              {[
                ...
                },
                {
                  ...
                  url:      "https://app.candid.org/profile/16517045/ghosts-worth-chasing-39-4369238",
